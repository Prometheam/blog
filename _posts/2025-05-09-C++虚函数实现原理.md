...
所以，通过基类指针调用虚函数时，会根据实际对象的vptr找到对应的虚函数表，然后调用正确的函数。这就是多态的实现机制。另外关于虚函数还有一些需要掌握的点，参见[虚函数常见问题](http://www.mengguowan.com/archives/620c07bd-160b-493b-a041-70b96f2aa9f5)
